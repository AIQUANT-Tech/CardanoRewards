...
import LoyaltyUserWalletTransaction from "../src/Loyalty_Rule_and_Transaction/Loyalty_User_Wallet_Transaction/Loyalty_User_Wallet_Transaction_Schema.js";
    ...
    setImmediate(async () => {
      try {
        ...
        const walletTx = new LoyaltyUserWalletTransaction({
          ...
          transaction_desc: `Redeemed ${reward_usage} rewards for booking ${rewardTx.transaction_id}`,
          created_by: "system",
          status: "A",
        });
        await walletTx.save();
