...
import { createUser, loginInfoForBusinessUser, loginInfoForEndUser, fetchEndUsersInfo } from './Loyalty_User_Mast_Controller.js';
...
jest.mock('../../Loyalty_Rule_and_Transaction/Loyalty_User_Wallet_Transaction/Loyalty_User_Wallet_Transaction_Schema.js');
...
describe('Loyalty User Controller Tests', () => {
  ...
  describe('Create User', () => {
    it('should create a new user successfully', async () => {
      ...
      expect(mockResponse.json).toHaveBeenCalledWith(expect.objectContaining({ message: 'User created successfully' }));
    });
  ...
  describe('Fetch End Users Info', () => {
    it('should fetch end users successfully', async () => {
      ...
      expect(mockResponse.status).toHaveBeenCalledWith(200);
      expect(mockResponse.json).toHaveBeenCalledWith(expect.objectContaining({ loyalty_end_users_info_rs: { user_info_list: expect.any(Object) } }));
    });
  });
});
